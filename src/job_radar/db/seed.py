...
INITIAL_BOARDS = [
    ...
    ("board-ameriprise", "Ameriprise", "phenom", "https://careers.ameriprise.com/search-jobs/?search=software&country=India&team=Technology&type=Full+Time&pagesize=20#results"),
    ...
    ("board-vanguard", "Vanguard", "google_cloud_talent_solution", "https://www.vanguardjobs.com/job-search-results/?location=IN%2C%20Telangana%2C%20Hyderabad&category[]=Technology&level[]=Experienced%20professionals"),
